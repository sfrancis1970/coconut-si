...
<?php echo form_input(array('name'=>'item','id'=>'item','size'=>'51'));?>
...
<th style="width:11%;"><?php echo $this->lang->line('sales_stock'); ?></th>
...
else
{
	...
	?>
		...
		<td><?php echo form_input(array('name'=>'stock','value'=>$item['stock'],'size'=>'3'));?></td>
...
<div id="overall_sale">
	...
	else
	{
		...
		<?php echo form_input(array('name'=>'customer','id'=>'customer','size'=>'20','value'=>$this->lang->line('sales_start_typing_customer_name')));?>
		</form>
